...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/') ?>admin1.css">
     ...
     <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
              <a class="nav-link" href="<?php echo base_url('') ?>admin/admin_kopi" id="nav">KOPI <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('') ?>admin/admin_tulisan"id="nav" > ARTIKEL <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('') ?>admin/admin_panduan" id="nav" >PANDUAN <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('') ?>admin/admin_pemesanan" id="nav" >PESANAN <span class="sr-only">(current)</span></a>
          </li> 
      </ul>
