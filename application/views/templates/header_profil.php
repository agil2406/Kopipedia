...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/') ?>profil.css">
      ...
      <ul class="navbar-nav pb-3">
        <li class="nav-item">
            <?php  if($this->session->userdata('username')) { ?>
              <a class="nav-link" id="nav"><?php echo anchor('auth/profil', '<div class="nav-link" id="nav">PROFIL <span class="sr-only">(current)</span></div>' ) ?></a>
              <?php }else{ ?> 
